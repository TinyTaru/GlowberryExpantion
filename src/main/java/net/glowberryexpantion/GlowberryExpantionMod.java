package net.glowberryexpantion;
...
@Mod("glowberry_expantion")
public class GlowberryExpantionMod {
	public static final Logger LOGGER = LogManager.getLogger(GlowberryExpantionMod.class);
	public static final String MODID = "glowberry_expantion";

	public GlowberryExpantionMod() {
		...
		GlowberryExpantionModEntities.REGISTRY.register(bus);
		...
		GlowberryExpantionModMenus.REGISTRY.register(bus);
