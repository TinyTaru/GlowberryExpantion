package net.glowberryexpantion.block.entity;
...
public class BlackstoneChestTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public BlackstoneChestTileEntity(BlockPos pos, BlockState state) {
		super(GlowberryExpantionModBlockEntities.BLACKSTONE_CHEST.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BlackstoneChestBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BlackstoneChestTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BlackstoneChestTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("blackstone_chest");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new BlackStoneChestGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Blackstone Chest");
	}
