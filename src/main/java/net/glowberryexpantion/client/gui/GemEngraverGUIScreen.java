...
public class GemEngraverGUIScreen extends AbstractContainerScreen<GemEngraverGUIMenu> {
	private final static HashMap<String, Object> guistate = GemEngraverGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	ImageButton imagebutton_progress_arrow_6;

	public GemEngraverGUIScreen(GemEngraverGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("glowberry_expantion:textures/screens/gem_engraver_gui.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + 31 && mouseY < topPos + 55)
			guiGraphics.renderTooltip(font, Component.translatable("gui.glowberry_expantion.gem_engraver_gui.tooltip_add_a_gem"), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("glowberry_expantion:textures/screens/empty_extract_bottle.png"), this.leftPos + 26, this.topPos + 36, 0, 0, 16, 16, 16, 16);
		...
		guiGraphics.blit(new ResourceLocation("glowberry_expantion:textures/screens/empty_chisel.png"), this.leftPos + 71, this.topPos + 36, 0, 0, 16, 16, 16, 16);
