...
import net.glowberryexpantion.item.model.VinedBlossemModel;
import net.glowberryexpantion.item.VinedBlossemItem;

public class VinedBlossemArmorRenderer extends GeoArmorRenderer<VinedBlossemItem> {
	public VinedBlossemArmorRenderer() {
		super(new VinedBlossemModel());
	...
	@Override
	public RenderType getRenderType(VinedBlossemItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
