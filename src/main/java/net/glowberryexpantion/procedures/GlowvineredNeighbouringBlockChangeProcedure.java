...
public class GlowvineredNeighbouringBlockChangeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if (world.isEmptyBlock(BlockPos.containing(x, 1 + y, z))) {
			world.destroyBlock(BlockPos.containing(x, y, z), false);
		} else if (GlowberryExpantionModBlocks.GLOWVINERED.get() == (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock()) {
