...
public class PurpleGlowberrysRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world.isEmptyBlock(BlockPos.containing(x, y - 1, z)) == true) {
			world.setBlock(BlockPos.containing(x, y - 1, z), GlowberryExpantionModBlocks.GLOWVINEPURPLE.get().defaultBlockState(), 3);
